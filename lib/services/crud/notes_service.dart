...
class NotesService {
  ...
  //Hacer que solo se pueda crear un objeto único de esa clase
  ...
  //broadcast hace que se pueda crear listeners del contenido en cualquier momento
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    //adding it to the array of notes
    _notes.add(note);
    _notesStreamController.add(_notes);
    return note;
  }
